...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('chat_messages', function (Blueprint $table) {
            ...
            $table->json('referenced_transactions')->nullable()
                  ->comment('Array of transaction IDs referenced in response');
            $table->json('referenced_categories')->nullable()
                  ->comment('Categories discussed in response');
            $table->json('referenced_accounts')->nullable()
                  ->comment('Accounts discussed in response');
            ...
            $table->integer('total_tokens')->default(0)
                  ->comment('Total tokens for this message');
            $table->decimal('cost', 10, 6)->default(0)
                  ->comment('Cost in USD for this message');
            ...
            $table->enum('user_rating', ['helpful', 'not_helpful'])->nullable()
                  ->comment('User feedback on assistant response');
